  ...
  return (
    <div className="container mx-auto p-6 xl:px-20">
      ...
      <div className="flex justify-start space-x-2 my-4">
        ...
        <button
          className="bg-gradient-to-r from-red-500 to-pink-400 text-white cursor-pointer py-1 px-2 text-xs rounded-md shadow-sm hover:from-red-600 hover:to-pink-500 transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50 flex items-center sm:py-2 sm:px-4 sm:text-sm"
        ...
        <button
          className="bg-gradient-to-r from-yellow-500 to-orange-400 text-white curs py-1 px-2 text-xs rounded-md shadow-sm hover:from-yellow-600 hover:to-orange-500 transition duration-300 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50 flex items-center sm:py-2 sm:px-4 sm:text-sm"
